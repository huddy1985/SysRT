...
public:
	...
	/*only dispatch the core where t was executing, this is used a core is
	 * free because a task is blocked, terminated, */
	virtual void dispatch(AbsRTTask* t) = 0;
	virtual void terminate(AbsRTTask *t)=0;
	/**
